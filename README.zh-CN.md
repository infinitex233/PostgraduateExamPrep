...
一个面向中国 11408 考研的文件化学习管理系统，在同一仓库中维护每日进度、阶段规划、教材检索、复习笔记和自动生成的学习看板。
...
教材源 PDF 和 OCR 缓存仅保存在本地。Git 主要跟踪维护系统所需的脚本、学习记录、笔记、说明文档和适合版本控制的派生成品。
