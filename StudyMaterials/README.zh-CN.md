...
教材 PDF 体积较大且可能涉及版权，只保存在本地对应目录，不得提交。OCR 缓存是可重建的本地派生数据，同样不得进入 Git。

Git 可以跟踪脚本、Markdown 笔记、说明文档，以及适合版本控制的复习成品，例如英语作文模板的 HTML 版本。
